...
class DashboardDefaultColumnWithLineChart extends StatefulHookConsumerWidget {
  const DashboardDefaultColumnWithLineChart({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _DashboardDefaultColumnWithLineChartState();
}

class _DashboardDefaultColumnWithLineChartState
    extends ConsumerState<DashboardDefaultColumnWithLineChart> {
