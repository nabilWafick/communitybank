...
class StockInputUpdateForm extends StatefulHookConsumerWidget {
  final Stock stock;
  const StockInputUpdateForm({
    super.key,
    required this.stock,
  });
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _StockInputUpdateFormState();
}

class _StockInputUpdateFormState extends ConsumerState<StockInputUpdateForm> {
                    ...
                    children: [
                      Container(
                        ...
                        child: CBFormProductDropdown(
                          ...
                          menuHeigth: 500.0,
                          label: 'Produit',
                          providerName: 'stock-update-input-product',
                      ...
                      Container(
                        ...
                        child: CBTextFormField(
                          ...
                          initialValue:
                              widget.stock.inputedQuantity?.toString(),
                  ...
                  showValidatedButton.value
                      ? SizedBox(
                          ...
                          child: CBElevatedButton(
                            text: 'Valider',
                            onPressed: () async {
                              StockCRUDFunctions.updateStockInput(
                                context: context,
                                formKey: formKey,
                                ref: ref,
                                stock: widget.stock,
