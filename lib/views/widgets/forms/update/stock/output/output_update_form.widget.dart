...
class StockOutputUpdateForm extends StatefulHookConsumerWidget {
  final Stock stock;
  const StockOutputUpdateForm({
    super.key,
    required this.stock,
  });
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _StockOutputUpdateFormState();
}

class _StockOutputUpdateFormState extends ConsumerState<StockOutputUpdateForm> {
                    ...
                    children: [
                      Container(
                        ...
                        child: CBFormProductDropdown(
                          ...
                          menuHeigth: 500.0,
                          label: 'Produit',
                          providerName: 'stock-update-output-product',
                      ...
                      Container(
                        ...
                        child: CBTextFormField(
                          ...
                          initialValue:
                              widget.stock.outputedQuantity?.toString(),
                  ...
                  showValidatedButton.value
                      ? SizedBox(
                          ...
                          child: CBElevatedButton(
                            text: 'Valider',
                            onPressed: () async {
                              StockCRUDFunctions.updateStockOutput(
                                context: context,
                                formKey: formKey,
                                ref: ref,
                                stock: widget.stock,
