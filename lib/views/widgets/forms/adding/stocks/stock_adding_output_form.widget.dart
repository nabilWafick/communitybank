...
class StockAddingOutputForm extends StatefulHookConsumerWidget {
  const StockAddingOutputForm({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _StockAddingOutputFormState();
}

class _StockAddingOutputFormState extends ConsumerState<StockAddingOutputForm> {
