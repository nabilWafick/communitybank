...
class PersonalStatusAddingForm extends StatefulHookConsumerWidget {
  const PersonalStatusAddingForm({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _PersonalStatusAddingFormState();
}

class _PersonalStatusAddingFormState
    extends ConsumerState<PersonalStatusAddingForm> {
                  ...
                  showValidatedButton.value
                      ? SizedBox(
                          ...
                          child: CBElevatedButton(
                            text: 'Valider',
                            onPressed: () async {
                              PersonalStatusCRUDFunctions.create(
                                context: context,
                                formKey: formKey,
                                ref: ref,
