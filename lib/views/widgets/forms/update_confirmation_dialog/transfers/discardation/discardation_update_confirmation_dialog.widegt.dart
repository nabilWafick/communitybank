...
class TransferDiscardationUpdateConfirmationDialog extends HookConsumerWidget {
  ...
  const TransferDiscardationUpdateConfirmationDialog({
    super.key,
                  ...
                  child: Row(
                    children: [
                      ...
                      const Flexible(
                        child: CBText(
                          text:
                              'Êtes-vous sûr de vouloir rejeter ce transfert ?',
                          fontSize: 15.0,
